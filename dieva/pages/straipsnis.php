...
if ( $_GET['v'] == 7 || isset( $url['h'] ) ) {
	...
	$icona      =	[
		'fab fa-facebook-f'		 => 'FB <i class="fab fa-facebook-f"></i>',
		'fab fa-accessible-icon' => 'Neigalus <i class="fab fa-accessible-icon"></i>',
		'fas fa-ambulance'       => 'Greitoji <i class="fas fa-ambulance"></i>',
		'fab fa-apple'           =>	'Apple logo	<i class="fab fa-apple"></i>',
	];
	...
	$straipsnis = array(
		...
		"{$lang['admin']['article_title']}:" 	=> array( "type" => "text", "value" => input( ( isset( $extra ) ) ? $extra['pav'] : '' ), "name" => "pav", "class" => "input" ), 
		"" => array( "type" => "hidden", "name" => "idas", "value" => ( isset( $extra['id'] ) ? input( $extra['id'] ) : '' ) ), 
